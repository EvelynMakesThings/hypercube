...
entity *newentity(int x, int y, int z, char *what, int v1, int v2, int v3, int v4)
{
    ...
    persistent_entity e = { static_cast<short>(x), static_cast<short>(y), static_cast<short>(z), static_cast<short>(v1), static_cast<uchar>(type), static_cast<uchar>(v2), static_cast<uchar>(v3), static_cast<uchar>(v4) };
    switch(type)
    {
        case LIGHT:
            if(v1>32) v1 = 32;
